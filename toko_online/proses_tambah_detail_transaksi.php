...
if($_POST){
    ...
    if(empty($id_produk)){
        ...
        $insert=mysqli_query($conn,"insert into detail_transaksi (id_transaksi,id_produk,qty,subtotal) value ('".$id_produk."', '".$id_produk."', '".$qty_produk."', '".$subtotal."')") or die(mysqli_error($conn));
