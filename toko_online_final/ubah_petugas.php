...
<body>
    ...
    <form action="proses_ubah_petugas.php" method="post">
        ...
        <textarea name="username_petugas" class="form-control" rows="4"><?=$dt_petugas['username']?></textarea>

        Password :

        <input type="password" name="pass_petugas" value="<?=$dt_petugas['password']?>" class="form-control">
